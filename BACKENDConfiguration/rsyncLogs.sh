...
source_file_rabbit="/var/log/rabbitmq/rabbit@backendPROD.log"
source_file_kern="/var/log/kern.log"
destination1="webserver@frontendPROD:/home/webserver/errorLogs/"
destination2="dmz@dmzPROD:/home/dmz/errorLogs/"
